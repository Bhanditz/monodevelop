...
namespace CorApi.ComInterop
{
    ...
    public interface ICorDebugRegisterSet
    {
        ...
        void GetRegisters ([In] ulong mask, [In] uint regCount,
            [MarshalAs (UnmanagedType.Interface), Out] ICorDebugRegisterSet regBuffer);
        ...
        void GetThreadContext ([In] uint contextSize,
            [MarshalAs (UnmanagedType.Interface), In, Out] ICorDebugRegisterSet context);

        [MethodImpl (MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        void SetThreadContext ([In] uint contextSize,
            [MarshalAs (UnmanagedType.Interface), In] ICorDebugRegisterSet context);
    }
}