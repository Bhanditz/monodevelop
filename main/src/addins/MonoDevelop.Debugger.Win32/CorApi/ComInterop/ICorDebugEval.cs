...
namespace CorApi.ComInterop
{
    ...
    public interface ICorDebugEval
    {
        ...
        void CallFunction ([MarshalAs (UnmanagedType.Interface), In] ICorDebugFunction pFunction, [In] uint nArgs,
            [MarshalAs (UnmanagedType.Interface), In] ref ICorDebugValue ppArgs);

        [MethodImpl (MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        void NewObject ([MarshalAs (UnmanagedType.Interface), In] ICorDebugFunction pConstructor, [In] uint nArgs,
            [MarshalAs (UnmanagedType.Interface), In] ref ICorDebugValue ppArgs);
        ...
        [MethodImpl (MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        void NewArray ([In] CorElementType elementType, [MarshalAs (UnmanagedType.Interface), In] ICorDebugClass pElementClass,
        ...
        [MethodImpl (MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        void CreateValue ([In] CorElementType elementType, [MarshalAs (UnmanagedType.Interface), In] ICorDebugClass pElementClass,
