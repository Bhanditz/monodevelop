...
namespace CorApi.ComInterop
{
    ...
    public interface ICorDebugAppDomain : ICorDebugController
    {
        ...
        [MethodImpl (MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        void GetModuleFromMetaDataInterface ([MarshalAs (UnmanagedType.IUnknown), In] object pIMetaData,
        ...
        void GetName ([In] uint cchName, out uint pcchName,
            [MarshalAs (UnmanagedType.Interface), Out] ICorDebugAppDomain szName);
