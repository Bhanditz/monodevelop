...
namespace CorApi.ComInterop
{
    ...
    public interface ICorDebugContext : ICorDebugObjectValue
    {
        ...
        [MethodImpl (MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        new void GetFieldValue ([MarshalAs (UnmanagedType.Interface), In] ICorDebugClass pClass, [In] uint fieldDef,
        ...
        [MethodImpl (MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        new void SetFromManagedCopy ([MarshalAs (UnmanagedType.IUnknown), In] object pObject);
    }
}