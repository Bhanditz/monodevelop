...
{
  // ReSharper disable InconsistentNaming, UnusedMember.Global, UnusedMember.Local
  ...
  // ReSharper restore InconsistentNaming, UnusedMember.Global, UnusedMember.Local
}